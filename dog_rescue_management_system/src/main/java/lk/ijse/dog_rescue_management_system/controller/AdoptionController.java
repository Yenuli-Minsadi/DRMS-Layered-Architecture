...
import lk.ijse.dog_rescue_management_system.bo.custom.impl.AdoptionProcessBOImpl;
...
//    AdoptionProcessBOImpl adoptionProcessBO = new AdoptionProcessBOImpl();
    AdoptionProcessBO adoptionProcessBO = (AdoptionProcessBO) BOFactory.getBoFactory().getBo(BOFactory.BOTypes.ADOPTIONPROCESSS);
...
//    private final AdoptionModel adoptionModel = new AdoptionModel();
    ...
    void btnAdoptionSaveOnAction(ActionEvent event) {
        ...
        try {
            boolean isSaved = adoptionProcessBO.save(adoptionProcessDto);
            if (isSaved) {
                resetPage();
    ...
    private void loadNextId() throws Exception {
        String nextId = adoptionProcessBO.getNextId();
        lblAdoptionId.setText(nextId);
    }

    private void loadTableData() throws SQLException, ClassNotFoundException {
        ArrayList<AdoptionProcessDto> adoptionProcessDtoArrayList =adoptionProcessBO.getAll();
...
//            lblRequestId.setText("");
    ...
    public void btnAdoptionUpdateOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean isUpdated = adoptionProcessBO.update(adoptionProcessDto);
            if (isUpdated) {
                resetPage();
    ...
    public void btnAdoptionDeleteOnAction(ActionEvent actionEvent) {
        ...
        if (response.isPresent() && response.get() == ButtonType.YES) {
            ...
            try {
                boolean isDeleted = adoptionProcessBO.delete(adoptionId);

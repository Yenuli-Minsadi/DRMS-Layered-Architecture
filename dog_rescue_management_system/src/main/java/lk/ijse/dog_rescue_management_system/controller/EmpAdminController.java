...
import lk.ijse.dog_rescue_management_system.bo.custom.impl.AdminBOImpl;
import lk.ijse.dog_rescue_management_system.dao.custom.AdminDAO;
import lk.ijse.dog_rescue_management_system.dao.custom.impl.AdminDAOImpl;
...
//      AdminBOImpl adminBO =  new AdminBOImpl();
    ...
    private void loadNextId() throws Exception {
        String nextId = adminBO.getNextAdminId();
        lblAdminId.setText(nextId);
    }


    private void loadTableData() throws SQLException, ClassNotFoundException {
        ArrayList<AdminDto> adminDtoArrayList = adminBO.getAllAdmins();
    ...
    public void btnAdminUpdateOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean isUpdated = adminBO.updateAdmin(adminDto);
            if (isUpdated) {
                resetPage();

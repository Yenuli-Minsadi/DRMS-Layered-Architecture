...
//      AdopterBOImpl adopterBO = new AdopterBOImpl();
       AdopterBO adopterBO = (AdopterBO) BOFactory.getBoFactory().getBo(BOFactory.BOTypes.ADOPTER);
    ...
    void btnAdopterSaveOnAction(ActionEvent event) {
        ...
        try {
            boolean isSaved = adopterBO.saveAdopter(adopterDto);
            if (isSaved){
                resetPage();
    ...
    private void loadNextId() throws Exception {
        String nextId = adopterBO.getNextAdopterId();
        lblAdopterId.setText(nextId);
    }

    private void loadTableData() throws SQLException, ClassNotFoundException {
        ArrayList<AdopterDto> adopterDtoArrayList =adopterBO.getAllAdopters();
...
//            lblRequestId.setText("");
    ...
    public void btnAdopterUpdateOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean isUpdated = adopterBO.updateAdopter(adopterDto);
            if (isUpdated){
                resetPage();
    ...
    public void btnAdopterDeleteOnAction(ActionEvent actionEvent) {
        ...
        if (response.isPresent() && response.get() == ButtonType.YES) {
            ...
            String adopterId = lblAdopterId.getText();
            try {
                boolean isDeleted = adopterBO.deleteAdopter(adopterId);

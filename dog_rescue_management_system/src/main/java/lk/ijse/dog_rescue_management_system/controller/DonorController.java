...
//      DonorBOImpl donorBO = new DonorBOImpl();
    ...
    void btnDonorSaveOnAction(ActionEvent event) {
        ...
        try {
            boolean isSaved = donorBO.saveDonor(donorDto);
            if (isSaved) {
                resetPage();
    ...
    private void loadNextId() throws Exception {
        String nextId = donorBO.getNextDonorId();
        lblDonorId.setText(nextId);
    }

    private void loadTableData() throws SQLException, ClassNotFoundException {
        ArrayList<DonorDto> donorDtoArrayList = donorBO.getAllDonors();
...
//            lblRequestId.setText("");
    ...
    public void btnDonorUpdateOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean isUpdated = donorBO.updateDonor(donorDto);
            if (isUpdated) {
                resetPage();

...
import lk.ijse.dog_rescue_management_system.bo.custom.impl.RequestCaseBOImpl;
...
//    RequestCaseDAO requestCaseDAO = new RequestCaseDAOImpl();
//      RequestCaseBOImpl requestCaseBO = new RequestCaseBOImpl();
    RequestCaseBO requestCaseBO = (RequestCaseBO) BOFactory.getBoFactory().getBo(BOFactory.BOTypes.REQUESTCASE);
    ...
    void btnCaseSaveOnAction(ActionEvent event) {
        ...
        try {
            boolean isSaved = requestCaseBO.saveRequest(requestCaseDto);
    ...
    private void loadNextId() throws Exception {
        String nextId = requestCaseBO.getNextRequestId();
        lblRequestId.setText(nextId);
    }

    private void loadTableData() throws SQLException, ClassNotFoundException {
        ArrayList<RequestCaseDto> requestCaseDtoArrayList = requestCaseBO.getAllRequests();
    ...
    public void btnCaseUpdateOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean isUpdated = requestCaseBO.updateRequest(requestCaseDto);
    ...
    public void btnCaseDeleteOnAction(ActionEvent actionEvent) {
        ...
        if (response.isPresent() && response.get() == ButtonType.YES) {
            ...
            String requestId = lblRequestId.getText();
            try {
                boolean isDeleted = requestCaseBO.deleteRequest(requestId);
